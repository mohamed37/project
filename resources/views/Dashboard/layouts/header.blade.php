<html class="loading" lang="{{App::getLocale()}}" data-textdirection="{{LaravelLocalization::getCurrentLocaleName() =='english' ? 'ltr' : 'rtl'}}">
  <head>
        ...
        <div class="navbar-container content">
          <div class="collapse navbar-collapse" id="navbar-mobile">
           ...
           <ul class="nav navbar-nav mr-auto">
              <li class="nav-item d-none d-md-block"><a class="nav-link nav-menu-main menu-toggle hidden-xs">asdd<i class="icon-menu5"></i></a></li>
              <li class="nav-item d-none d-md-block"><a class="nav-link nav-link-expand" href="#">ss<i class="ficon icon-expand2"></i></a></li>
            </ul>
            ...
            @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
              @if($properties['name'] != LaravelLocalization::getCurrentLocaleName())
               <li class="nav-item">
                 <a class="btn btn-warning btn-doc-header" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}" >
                   <img style="width: 30px;margin: 0px 3px;border-radius: 38%;" 
                     src="{{asset(App::getLocale() == 'en' ? 'app-assets/images/flags/egypt.svg' : 'app-assets/images/flags/united-states.svg')}}">
                     {{$properties['native']}} 
                 </a>
               </li>
               @endif
